...
import { APP_URL, MOCK_URL, launch, reporter } from "./harness.mjs";
...
// Find a free-text question (skip past multiple-choice ones).
let answered = false;
...
check("found a free-text question to grade", answered);
