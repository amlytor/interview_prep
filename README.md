...
**Depth is tiered by judgement, not applied flat.** Twenty-six topics carry
...
valuation. Black-Scholes and implied volatility each have their own topic —
the derivation, the PDE, the assumptions and which fail, the smile and skew,
surface arbitrage constraints, VIX. Derivatives and the Greeks is the largest
topic at 67 questions, covering both the puzzle angle and the desk-practice one. The questions
