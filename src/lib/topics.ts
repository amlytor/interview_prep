...
// union half keeps editor autocomplete for the 33 seeded ids, the `string`
...
/** The 33 seeded topics plus whatever the user has added, for pickers. */
...
/** True for one of the 33 seeded ids (not user-created ones). */
